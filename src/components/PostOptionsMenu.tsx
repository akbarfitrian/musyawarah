...
/**
 * "..." menu in the top-right corner of a post. Right now it only holds
 * "Copy link to post" (reusing the same copy-to-clipboard behavior as
 * CopyLinkButton), but it's built as a dropdown so more actions can be
 * added as rows later without changing the trigger.
 */
export function PostOptionsMenu({ path, className = '' }: { path: string; className?: string }) {
